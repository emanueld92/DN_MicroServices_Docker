...
namespace MicroservicioVentas.EntityFramework.Repositories
{
    public class Repository<TId, TEntity> : IRepository<TId, TEntity> where TEntity : class, new()
    {
        ...
        private readonly MicroservicioVentasDataContext _context;

        protected MicroservicioVentasDataContext Context { get => _context;  }

        public Repository(MicroservicioVentasDataContext context)
        {
            _context = context;
        }
